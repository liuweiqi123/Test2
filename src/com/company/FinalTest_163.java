...
import static com.company.WeatherUtil.getURLInfo;

public class FinalTest_163 {
    static WeatherUtil weatherUtil=new WeatherUtil();
    // 发件人 账号和密码
    public static final String MY_EMAIL_ACCOUNT = "18302917011@163.com";
    public static final String MY_EMAIL_PASSWORD = "ff123456789";// 密码,是你自己的设置的授权码
    ...
    // 收件人
    public static final String RECEIVE_EMAIL_ACCOUNT = "2841436785@qq.com";
...
//		message.setRecipients(Message.RecipientType.CC, MY_EMAIL_ACCOUNT);
        ...
        message.setSubject("春蕾");
        message.setText("武汉"+list.toString());
